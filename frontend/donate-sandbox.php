...
<link rel="stylesheet" href="../css/jquery.collapse.css" type="text/css" media="all" />
...
<div class="row-fluid">
	...
	<div class="span6">
		...
		Choose how you would like to divide up your contribution (click on the projects to learn more about how the money will be spent):<br />
		<div>
			<a href="#" data-toggle="collapse" data-target="#collapse_alpha" class="collapse slider-label">Apertus Alpha (Axiom Prototype)</a>
			...
			<div class="collapse in" id="collapse_alpha">
				<div class="well">
		...
		<div>
			<a href="#" data-toggle="collapse" data-target="#collapse_opencine" class="collapse slider-label">Open Cine - free RAW processing suite</a>
			...
			<div class="collapse in" id="collapse_opencine">
				<div class="well">
					<img src="http://apertus.org/sites/default/files/JP4ToolsGUI_05.jpg" style="margin-bottom:20px;"><br />
					Unfortunately there is no software developers working on the development of the only free raw motion picture footage development/processing suite <a target="_blank" href="http://apertus.org/en/opencine">Open Cine</a> yet.<br />
		...
		<div>
			<a href="#" data-toggle="collapse" data-target="#collapse_dictator" class="collapse slider-label">Dictator Interface</a>
			...
			<div class="collapse in" id="collapse_dictator">
				<div class="well">
					<img src="http://apertus.org/sites/default/files/dictatorIIconcept04.jpg" style="margin-bottom:20px;">Interview with Bob Primes, ASC<br />
					To develop the <a href="http://apertus.org/en/dictator" target="_blank">Dictator</a> from a concept to an actual device we need to pay a hardware/PCB designer. These guys are not cheap, but since the device is rather simple from the required electronic components
		...
		<div>
			<a href="#" data-toggle="collapse" data-target="#collapse_website" class="collapse slider-label">Website Hosting and Domain Fees</a>
			...
			<div class="collapse in" id="collapse_website">
				<div class="well">
					We already pay website hosting and domain fees for several years privately without anyone ever asking. Donate some money here to make sure we can afford this in the future without 
					paying it from our own pockets anymore.
				</div>
			</div>
		</div>

		<div>
			<a href="#" data-toggle="collapse" data-target="#collapse_hollywood" class="collapse slider-label">"Open Camera goes Hollywood" documentary film</a>
			...
			<div class="collapse in" id="collapse_hollywood">
				<div class="well">
				
					<img src="img/bob_primes.jpg" style="margin-bottom:20px;"><br />
					Help us cover travel expenses or gear rental for the <a target="_blank" href="http://apertus.org/en/hollywood">"Hollywood loves Open Source" documentary film</a>. Which will be released under the creative commons for everyone.
		...
		<div>
			<a href="#" data-toggle="collapse" data-target="#collapse_misc" class="collapse slider-label">Let Apertus decide</a>
			...
			<div class="collapse in" id="collapse_misc">
				<div class="well">
	...
	function ValidateInput() {
		...
		//TODO check for invalid input: email address format, donation amount, slider values (sum != 100)
		var data = {
			Email: $('#email').val(),
